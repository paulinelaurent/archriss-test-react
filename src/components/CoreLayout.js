  ...
  <div className='CoreLayout'>
    ...
    <div className='CoreLayout--viewport'>
      <div className='CoreLayout--background'>
        ...
        <ArticleContent
          category='Culture'
          thumbnail='http://i.imgur.com/f5fJ67T.jpg'
          location='Nîmes'
